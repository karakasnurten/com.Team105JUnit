...
public class C03_WindowHandle {
    ...
    public void test01() throws InterruptedException {
        // htpps://the-internet.herokuapp.com/iframe adresine gidin
        driver.get("htpps://the-internet.herokuapp.com/iframe");

        // elemental selenium linkini tiklayin
        // linke tikladigimizda yeni sayfa acilacagindan
        // click yapmadan once ilk sayfanini WHD'ini alip kaydedelim
        ...
        Set<String> ikiSayfaniniWHDegerlerSeti = driver.getWindowHandles();

        String ikinciSayfaWHD ="";

        for (String eachWHD: ikiSayfaniniWHDegerlerSeti){
        ...
        // yeni tab'a gecip sayfadaki en buyuk yazinin "Elemental Selenium" oldugunu test edin
        String expectedIkinciSayfaYazi= "Elementel Selenium";
        String actualIkiniciSayfaYazi= driver.findElement(By.tagName("h1")).getText();

        Assert.assertEquals(expectedIkinciSayfaYazi,actualIkiniciSayfaYazi);
